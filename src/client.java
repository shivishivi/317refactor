...
public final class client extends RSApplet
{
	...
	private void drawChatArea()
	{
		...
		else
		{
					...
					if (l == 6 && splitPrivateChat == 0 && privateChatMode < 2)
					{
						if (i1 > 0 && i1 < 110)
						{
							...
							textDrawingArea.method385(
									...
									chatMessages[k],
									i1,
									12 + textDrawingArea.getTextWidth("To "
											+ s1));
						}
						j++;
					}
			...
			textDrawingArea.method385(255, inputString + "*", 90,
					6 + textDrawingArea.getTextWidth(s + ": "));
			...
			int i1, int j1)
	{
		...
		for (int l1 = 0; l1 < k1; l1++)
		{
			...
			if ((class9_1.anInt230 >= 0 || class9_1.anInt216 != 0) && k >= i2
	...
	private void processChatModeClick()
	{
		if (super.clickMode3 == 1)
		{
					...
					&& super.saveClickY >= 467 && super.saveClickY <= 499)
			{
				...
				aBoolean1233 = true;
				inputTaken = true;
				outStream1.createFrame(95);
				outStream1.put(publicChatMode);
				outStream1.put(privateChatMode);
				outStream1.put(tradeMode);
			}
			...
			{
				anInt940 = 0;
				outStream1.createFrame(165);
				outStream1.put(0);
				int j = outStream1.offset;
				outStream1.put(139);
				outStream1.put(150);
				outStream1.writeWord(32131);
				outStream1.put((int) (Math.random() * 256D));
				outStream1.writeWord(3250);
				outStream1.put(177);
				outStream1.writeWord(24859);
				outStream1.put(119);
				if ((int) (Math.random() * 2D) == 0)
					outStream1.writeWord(47234);
				if ((int) (Math.random() * 2D) == 0)
					outStream1.put(21);
				outStream1.writeBytes(outStream1.offset - j);
			}
		}
	}
	...
	private void delFriend(long l)
	{
		try
		{
			...
			for (int i = 0; i < friendsCount; i++)
			{
				...
				outStream1.createFrame(215);
				outStream1.writeQWord(l);
				break;
			}
		}
	...
	private void drawTabArea()
	{
		...
		if (invOverlayInterfaceID != -1)
			drawInterface(0, 0,
					RSInterface.interfaceCache[invOverlayInterfaceID], 0);
		else if (tabInterfaceIDs[tabID] != -1)
			drawInterface(0, 0,
					RSInterface.interfaceCache[tabInterfaceIDs[tabID]], 0);
	...
	private void method37(int j)
	{
		if (!highMemory)
		{
			if (Texture.anIntArray1480[17] >= j)
			{
				...
				{
					anInt854 = 0;
					outStream1.createFrame(226);
					outStream1.put(0);
					int l2 = outStream1.offset;
					outStream1.writeWord(58722);
					outStream1.put(240);
					outStream1.writeWord((int) (Math.random() * 65536D));
					outStream1.put((int) (Math.random() * 256D));
					if ((int) (Math.random() * 2D) == 0)
						outStream1.writeWord(51825);
					outStream1.put((int) (Math.random() * 256D));
					outStream1.writeWord((int) (Math.random() * 65536D));
					outStream1.writeWord(7130);
					outStream1.writeWord((int) (Math.random() * 65536D));
					outStream1.writeWord(61657);
					outStream1.writeBytes(outStream1.offset - l2);
				}
			}
	...
	private boolean promptUserForInput(RSInterface class9)
	{
		...
		if (j == 326)
		{
			outStream1.createFrame(101);
			outStream1.put(aBoolean1047 ? 0 : 1);
			for (int i1 = 0; i1 < 7; i1++)
				outStream1.put(anIntArray1065[i1]);

			for (int l1 = 0; l1 < 5; l1++)
				outStream1.put(anIntArray990[l1]);
		...
		if (j >= 601 && j <= 612)
		{
			...
			{
				outStream1.createFrame(218);
				outStream1.writeQWord(TextClass.longForName(reportAbuseInput));
				outStream1.put(j - 601);
				outStream1.put(canMute ? 1 : 0);
			}
		}
		return false;
	}
	...
	private void mainGameProcessor()
	{
		...
		synchronized (mouseDetection.syncObject)
		{
			if (flaggedCheating)
			{
				...
				{
					outStream1.createFrame(45);
					outStream1.put(0);
					int j2 = outStream1.offset;
					int j3 = 0;
					for (int j4 = 0; j4 < mouseDetection.coordsIndex; j4++)
					{
						if (j2 - outStream1.offset >= 240)
							break;
						j3++;
						...
						else
						{
									...
									&& k6 >= -32 && k6 <= 31)
							{
								j6 += 32;
								k6 += 32;
								outStream1.writeWord((anInt1022 << 12) + (j6 << 6)
										+ k6);
								anInt1022 = 0;
							}
							else if (anInt1022 < 8)
							{
								outStream1.writeDWordBigEndian(0x800000
										+ (anInt1022 << 19) + i6);
								anInt1022 = 0;
							}
							else
							{
								outStream1.putInt(0xc0000000
										+ (anInt1022 << 19) + i6);
								anInt1022 = 0;
							}
						}
					...
					outStream1.writeBytes(outStream1.offset - j2);
		...
		if (super.clickMode3 != 0)
		{
			...
			if (super.clickMode3 == 2)
				j5 = 1;
			int l5 = (int) l;
			outStream1.createFrame(241);
			outStream1.putInt((l5 << 20) + (j5 << 19) + k4);
		}
		if (anInt1016 > 0)
			anInt1016--;
			...
			if (super.clickMode2 == 0)
			{
				...
				if (aBoolean1242 && anInt989 >= 5)
				{
							...
							&& mouseInvInterfaceIndex != anInt1085)
					{
						...
						outStream1.createFrame(214);
						outStream1.method433(anInt1084);
						outStream1.method424(j1);
						outStream1.method433(anInt1085);
						outStream1.method431(mouseInvInterfaceIndex);
					}
				}
		...
		try
		{
			if (socketStream != null && outStream1.offset > 0)
			{
				socketStream.write(outStream1.offset, outStream1.buffer);
				outStream1.offset = 0;
				anInt1010 = 0;
			}
		}
	...
	private void doAction(int i)
	{
		...
		if (l == 582)
		{
			...
			if (npc != null)
			{
				...
				crossType = 2;
				crossIndex = 0;
				outStream1.createFrame(57);
				outStream1.method432(anInt1285);
				outStream1.method432(i1);
				outStream1.method431(anInt1283);
				outStream1.method432(anInt1284);
			}
		}
		if (l == 234)
		{
			...
			crossType = 2;
			crossIndex = 0;
			outStream1.createFrame(236);
			outStream1.method431(k + baseY);
			outStream1.writeWord(i1);
			outStream1.method431(j + baseX);
		}
		if (l == 62 && method66(i1, k, j))
		{
			outStream1.createFrame(192);
			outStream1.writeWord(anInt1284);
			outStream1.method431(i1 >> 14 & 0x7fff);
			outStream1.method433(k + baseY);
			outStream1.method431(anInt1283);
			outStream1.method433(j + baseX);
			outStream1.writeWord(anInt1285);
		}
		if (l == 511)
		{
			...
			crossType = 2;
			crossIndex = 0;
			outStream1.createFrame(25);
			outStream1.method431(anInt1284);
			outStream1.method432(anInt1285);
			outStream1.writeWord(i1);
			outStream1.method432(k + baseY);
			outStream1.method433(anInt1283);
			outStream1.writeWord(j + baseX);
		}
		if (l == 74)
		{
			outStream1.createFrame(122);
			outStream1.method433(k);
			outStream1.method432(j);
			outStream1.method431(i1);
		...
		if (l == 315)
		{
			...
			if (flag8)
			{
				outStream1.createFrame(185);
				outStream1.writeWord(k);
			}
		}
		if (l == 561)
		{
			...
			if (player != null)
			{
				...
				if (anInt1188 >= 90)
				{
					outStream1.createFrame(136);
					anInt1188 = 0;
				}
				outStream1.createFrame(128);
				outStream1.writeWord(i1);
			}
		}
		if (l == 20)
		...
		if (l == 1062)
		{
			...
			if (anInt924 >= 113)
			{
				outStream1.createFrame(183);
				outStream1.writeDWordBigEndian(0xe63271);
				anInt924 = 0;
			}
			method66(i1, k, j);
			outStream1.createFrame(228);
			outStream1.method432(i1 >> 14 & 0x7fff);
			outStream1.method432(k + baseY);
			outStream1.writeWord(j + baseX);
		}
		if (l == 679 && !aBoolean1149)
		{
			outStream1.createFrame(40);
			outStream1.writeWord(k);
			aBoolean1149 = true;
		}
		if (l == 431)
		{
			outStream1.createFrame(129);
			outStream1.method432(j);
			outStream1.writeWord(k);
			outStream1.method432(i1);
			atInventoryLoopCycle = 0;
		...
		if (l == 53)
		{
			outStream1.createFrame(135);
			outStream1.method431(j);
			outStream1.method432(k);
			outStream1.method431(i1);
			atInventoryLoopCycle = 0;
			atInventoryInterface = k;
			atInventoryIndex = j;
		...
		if (l == 539)
		{
			outStream1.createFrame(16);
			outStream1.method432(i1);
			outStream1.method433(j);
			outStream1.method433(k);
			atInventoryLoopCycle = 0;
			atInventoryInterface = k;
			atInventoryIndex = j;
		...
		if (l == 484 || l == 6)
		{
			...
			if (l1 != -1)
			{
				...
				for (int j3 = 0; j3 < playerCount; j3++)
				{
					...
					if (l == 484)
					{
						outStream1.createFrame(139);
						outStream1.method431(playerIndices[j3]);
					}
					if (l == 6)
					{
						anInt1188 += i1;
						...
						outStream1.createFrame(128);
						outStream1.writeWord(playerIndices[j3]);
					}
					flag9 = true;
					break;
				}
		...
		if (l == 870)
		{
			outStream1.createFrame(53);
			outStream1.writeWord(j);
			outStream1.method432(anInt1283);
			outStream1.method433(i1);
			outStream1.writeWord(anInt1284);
			outStream1.method431(anInt1285);
			outStream1.writeWord(k);
			atInventoryLoopCycle = 0;
			atInventoryInterface = k;
			atInventoryIndex = j;
		...
		if (l == 27)
		{
			...
			if (class30_sub2_sub4_sub1_sub2_2 != null)
			{
				...
				if (anInt986 >= 54)
				{
					outStream1.createFrame(189);
					outStream1.put(234);
					anInt986 = 0;
				}
				outStream1.createFrame(73);
				outStream1.method431(i1);
			}
		}
		if (l == 213)
		{
			...
			crossType = 2;
			crossIndex = 0;
			outStream1.createFrame(79);
			outStream1.method431(k + baseY);
			outStream1.writeWord(i1);
			outStream1.method432(j + baseX);
		}
		if (l == 632)
		{
			outStream1.createFrame(145);
			outStream1.method432(k);
			outStream1.method432(j);
			outStream1.method432(i1);
			atInventoryLoopCycle = 0;
		...
		if (l == 94)
		{
			...
			crossType = 2;
			crossIndex = 0;
			outStream1.createFrame(181);
			outStream1.method431(k + baseY);
			outStream1.writeWord(i1);
			outStream1.method431(j + baseX);
			outStream1.method432(anInt1137);
		}
		if (l == 646)
		{
			outStream1.createFrame(185);
		...
		if (l == 225)
		{
			...
			if (class30_sub2_sub4_sub1_sub1_2 != null)
			{
				...
				if (anInt1226 >= 85)
				{
					outStream1.createFrame(230);
					outStream1.put(239);
					anInt1226 = 0;
				}
				outStream1.createFrame(17);
				outStream1.method433(i1);
			}
		}
		if (l == 965)
		{
			...
			if (class30_sub2_sub4_sub1_sub1_3 != null)
			{
				...
				if (anInt1134 >= 96)
				{
					outStream1.createFrame(152);
					outStream1.put(88);
					anInt1134 = 0;
				}
				outStream1.createFrame(21);
				outStream1.writeWord(i1);
			}
		}
		if (l == 413)
		...
		{
			method66(i1, k, j);
			outStream1.createFrame(252);
			outStream1.method433(i1 >> 14 & 0x7fff);
			outStream1.method431(k + baseY);
			outStream1.method432(j + baseX);
		}
		if (l == 412)
		...
		if (l == 365)
		{
			...
			if (class30_sub2_sub4_sub1_sub2_3 != null)
			{
				...
				crossType = 2;
				crossIndex = 0;
				outStream1.createFrame(249);
				outStream1.method432(i1);
				outStream1.method431(anInt1137);
			}
		}
		if (l == 729)
		{
		...
		if (l == 867)
		{
			...
			if (anInt1175 >= 59)
			{
				outStream1.createFrame(200);
				outStream1.writeWord(25501);
				anInt1175 = 0;
			}
			outStream1.createFrame(43);
			outStream1.method431(k);
			outStream1.method432(i1);
			outStream1.method432(j);
			atInventoryLoopCycle = 0;
			atInventoryInterface = k;
		...
		if (l == 478)
		{
			...
			if (class30_sub2_sub4_sub1_sub1_7 != null)
			{
				...
				if (anInt1155 >= 53)
				{
					outStream1.createFrame(85);
					outStream1.put(66);
					anInt1155 = 0;
				}
				outStream1.createFrame(18);
				outStream1.method431(i1);
			}
		}
		if (l == 113)
		{
			method66(i1, k, j);
			outStream1.createFrame(70);
			outStream1.method431(j + baseX);
			outStream1.writeWord(k + baseY);
			outStream1.method433(i1 >> 14 & 0x7fff);
		}
		if (l == 872)
		{
			method66(i1, k, j);
			outStream1.createFrame(234);
			outStream1.method433(j + baseX);
			outStream1.method432(i1 >> 14 & 0x7fff);
			outStream1.method433(k + baseY);
		}
		...
		{
			method66(i1, k, j);
			outStream1.createFrame(132);
			outStream1.method433(j + baseX);
			outStream1.writeWord(i1 >> 14 & 0x7fff);
			outStream1.method432(k + baseY);
		}
		if (l == 1125)
		{
		...
		do
		{
			...
			else if (messagePromptRaised)
			{
				...
				if (j == 13 || j == 10)
				{
					...
					{
						outStream1.createFrame(126);
						outStream1.put(0);
						int k = outStream1.offset;
						outStream1.writeQWord(aLong953);
						TextInput.method526(promptInput, outStream1);
						outStream1.writeBytes(outStream1.offset - k);
			...
			else if (inputDialogState == 1)
			{
				...
				if (j == 13 || j == 10)
				{
					if (amountOrNameInput.length() > 0)
					{
						...
						outStream1.createFrame(208);
						outStream1.putInt(i1);
					}
					inputDialogState = 0;
					inputTaken = true;
				}
			...
			else if (inputDialogState == 2)
			{
				...
				if (j == 13 || j == 10)
				{
					if (amountOrNameInput.length() > 0)
					{
						outStream1.createFrame(60);
						outStream1.writeQWord(TextClass
			...
			else if (backDialogID == -1)
			{
				...
				if ((j == 13 || j == 10) && inputString.length() > 0)
				{
					...
					{
						outStream1.createFrame(103);
						outStream1.put(inputString.length() - 1);
						outStream1.putString(inputString.substring(2));
					}
					else
					{
						...
						outStream1.createFrame(4);
						outStream1.put(0);
						int j3 = outStream1.offset;
						outStream1.method425(i3);
						outStream1.method425(j2);
						aStream_834.offset = 0;
						TextInput.method526(inputString, aStream_834);
						outStream1.method441(0, aStream_834.buffer,
								aStream_834.offset);
						outStream1.writeBytes(outStream1.offset - j3);
	...
	private void login(String username, String password,
			boolean recoveringConnection)
	{
		signlink.username = username;
		try
		{
			if (!recoveringConnection)
			{
				// If the connection attempt is a new connection, and hasn't
				// been called programmatically after disconnecting, show 
			...
			if (statusCode == 0)
			{
				// If the status code is 0, begin the main part of the login.
				socketStream.read(inStream.buffer, 8);
				inStream.offset = 0;
				
				// The server sends the client a long, this long is used to create
				// a unique seed for packet masking.
				isaacSeed = inStream.getLong();
				int seed[] = new int[4];
				seed[0] = (int) (Math.random() * 99999999D);
				seed[1] = (int) (Math.random() * 99999999D);
				seed[2] = (int) (isaacSeed >> 32);
				seed[3] = (int) isaacSeed;
				
				outStream1.offset = 0;
				// The "magic number" 10 is queued, although it isn't sent yet. Let's call this "queue B".
				outStream1.put(10);
				// The encryption seed is then added to queue B, this is used to create the session keys for
				// the client and the server to use when communicating.
				...
				outStream2.offset = 0;
				// Either 18 or 16 is added to queue A, based on whether or not the client is a new connection or is
				// a recovering, previously lost connection.
				if (recoveringConnection)
					outStream2.put(18);
				else
					outStream2.put(16);
				
				// The size of the rest of the login packet is then sent so that the server knows how many bytes to read.
				// The size of queue B, followed by the rest of queue A.
				outStream2.put(outStream1.offset + 36 + 1 + 1 + 2);
				// The second magic number, 255, is then added to the queue.
				outStream2.put(255);
				...
				// The CRC32 checksums of the 9 file archives are sent so that the server can
				// verify whether the client is up to date or not.
				for (int archive = 0; archive < 9; archive++)
					outStream2.putInt(crcChecksums[archive]);
				
				// Queue B, the encrypted part of the login block, is added to the end of queue A.
				outStream2.putBytes(outStream1.buffer, outStream1.offset, 0);
				
				// ISAAC ciphers are then generated from the client and server session keys generated earlier.
				outStream1.encryption = new ISAACRandomGen(seed);
				for (int i = 0; i < 4; i++)
					seed[i] += 50;
				encryption = new ISAACRandomGen(seed);
				
				socketStream.write(outStream2.offset,
						outStream2.buffer);
				
				statusCode = socketStream.read();
			}
			if (statusCode == 1)
			{
				// If the status code 1 was received, then the client will wait for 2000ms before trying to
				// connect again.
				try
				{
					Thread.sleep(2000);
			...
			if (statusCode == 2)
			{
				...
				// A byte is then received to signify whether the player has been flagged as a potential botter
				// or not. If they have, mouse information and other things will be sent to the server.
				flaggedCheating = socketStream.read() == 1;
				aLong1220 = 0L;
				anInt1022 = 0;
				mouseDetection.coordsIndex = 0;
				super.awtFocus = true;
			...
			int l1, int i2, int j2, boolean flag, int k2)
	{
		...
		if (i4 > 0)
		{
			...
			if (anInt1288 >= 92)
			{
				outStream1.createFrame(36);
				outStream1.putInt(0);
				anInt1288 = 0;
			}
			if (i == 0)
			{
				outStream1.createFrame(164);
				outStream1.put(k4 + k4 + 3);
			}
			if (i == 1)
			{
				outStream1.createFrame(248);
				outStream1.put(k4 + k4 + 3 + 14);
			}
			if (i == 2)
			{
				outStream1.createFrame(98);
				outStream1.put(k4 + k4 + 3);
			}
			outStream1.method433(k6 + baseX);
			destX = bigX[0];
			destY = bigY[0];
			for (int j7 = 1; j7 < k4; j7++)
			{
				i4--;
				outStream1.put(bigX[i4] - k6);
				outStream1.put(bigY[i4] - i7);
			}

			outStream1.method431(i7 + baseY);
			outStream1.method424(super.keyArray[5] != 1 ? 0 : 1);
			return true;
		}
		return i != 1;
	}
	...
	void startUp()
	{
		...
		try
		{
			...
			backLeftIP1 = new RSImageProducer(sprite.myWidth, sprite.myHeight,
					getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "backleft2", 0);
			backLeftIP2 = new RSImageProducer(sprite.myWidth, sprite.myHeight,
					getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "backright1", 0);
			backRightIP1 = new RSImageProducer(sprite.myWidth, sprite.myHeight,
					getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "backright2", 0);
			backRightIP2 = new RSImageProducer(sprite.myWidth, sprite.myHeight,
					getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "backtop1", 0);
			backTopIP1 = new RSImageProducer(sprite.myWidth, sprite.myHeight,
					getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "backvmid1", 0);
			backVmidIP1 = new RSImageProducer(sprite.myWidth, sprite.myHeight,
					getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "backvmid2", 0);
			backVmidIP2 = new RSImageProducer(sprite.myWidth, sprite.myHeight,
					getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "backvmid3", 0);
			backVmidIP3 = new RSImageProducer(sprite.myWidth, sprite.myHeight,
					getGameComponent());
			sprite.method346(0, 0);
			sprite = new Sprite(streamLoader_2, "backhmid2", 0);
			backVmidIP2_2 = new RSImageProducer(sprite.myWidth,
	...
	private void processMainScreenClick()
	{
		...
		if (super.clickMode3 == 1)
		{
			...
			{
				anInt1117 = 0;
				outStream1.createFrame(246);
				outStream1.put(0);
				int l = outStream1.offset;
				if ((int) (Math.random() * 2D) == 0)
					outStream1.put(101);
				outStream1.put(197);
				outStream1.writeWord((int) (Math.random() * 65536D));
				outStream1.put((int) (Math.random() * 256D));
				outStream1.put(67);
				outStream1.writeWord(14214);
				if ((int) (Math.random() * 2D) == 0)
					outStream1.writeWord(29487);
				outStream1.writeWord((int) (Math.random() * 65536D));
				if ((int) (Math.random() * 2D) == 0)
					outStream1.put(220);
				outStream1.put(180);
				outStream1.writeBytes(outStream1.offset - l);
			}
		}
	}
	...
	private void drawGameScreen()
	{
		...
		if (tabAreaAltered)
		{
			...
			{
				anInt1054 = -1;
				outStream1.createFrame(120);
				outStream1.put(tabID);
			}
	...
	private void drawInterface(int j, int k, RSInterface class9, int l)
	{
		...
		for (int j2 = 0; j2 < i2; j2++)
		{
			...
			if (class9_1.type == 0)
			{
				...
				if (class9_1.scrollMax > class9_1.height)
					method30(class9_1.height, class9_1.scrollPosition, l2, k2
							+ class9_1.width, class9_1.scrollMax);
			}
				...
				else if (class9_1.type == 6)
				{
					...
					int i5 = Texture.anIntArray1470[class9_1.anInt270]
							* class9_1.anInt269 >> 16;
					int l5 = Texture.anIntArray1471[class9_1.anInt270]
							* class9_1.anInt269 >> 16;
	...
	private void method108()
	{
		try
		{
			...
			{
				anInt1005 = 0;
				outStream1.createFrame(77);
				outStream1.put(0);
				int i2 = outStream1.offset;
				outStream1.put((int) (Math.random() * 256D));
				outStream1.put(101);
				outStream1.put(233);
				outStream1.writeWord(45092);
				if ((int) (Math.random() * 2D) == 0)
					outStream1.writeWord(35784);
				outStream1.put((int) (Math.random() * 256D));
				outStream1.put(64);
				outStream1.put(38);
				outStream1.writeWord((int) (Math.random() * 65536D));
				outStream1.writeWord((int) (Math.random() * 65536D));
				outStream1.writeBytes(outStream1.offset - i2);
			}
			int j2 = k1 * 192;
			if (j2 > 0x17f00)
				j2 = 0x17f00;
	...
	private boolean parsePacket()
	{
		...
		try
		{
			...
			if (pktType == -1)
			{
				socketStream.read(inStream.buffer, 1);
			...
			if (pktSize == -2)
				if (i > 1)
				{
					socketStream.read(inStream.buffer, 2);
					inStream.offset = 0;
			...
			if (i < pktSize)
				return false;
			inStream.offset = 0;
			socketStream.read(inStream.buffer, pktSize);
			anInt1009 = 0;
			anInt843 = anInt842;
			anInt842 = anInt841;
			anInt841 = pktType;
	...
	private final int[] crcChecksums;
